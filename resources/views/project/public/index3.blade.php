            ...
            <div class="col-md-12">
                <div class="card" style="width:1200px; margin-left:80px">
                    <div class="card-header text-bg-dark p-3">
                        <h3>
                            Available Hair Treatment Products
                        </h3>
                    </div>

                    <div class="card-body">
                    <a href="{{url('Create13')}}" class="btn btn-success btn-sm">Add Products</a>
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('Edit3/'.$item->id)}}" class="btn btn-primary btn-sm">Edit</a></td>
                                    <td>
                                     <a href="{{url('Delete3/'.$item->id)}}" class="btn btn-danger btn-sm">Delete</a>
                                    </td>
