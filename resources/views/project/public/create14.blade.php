...
<head>
    ...
    <title>Facial Product Adding Form</title>
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4>
                            Add Products
                            <a href="{{url('Index4')}}" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <form action="{{url('Create14')}}" method="POST" enctype="multipart/form-data">
                        @csrf
