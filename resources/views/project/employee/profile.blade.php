...
@endif
                        <!-- Form START -->
                        <form class="file-upload" method="POST" action="{{ route('update-profile', ['id' => $user->id]) }}">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    aria-label="First name" name="fname" value="{{$user->fname}}">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    aria-label="Phone number" name="phone_number" value="{{$user->phone_number}}">
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                    ...
                                                    *</label>
                                                <input type="text" class="form-control" placeholder="" name="birth_date"
                                                    aria-label="Pinterest" value="{{$personal_information->birth_date}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                        class="fab fa-fw fa-facebook me-2 text-facebook"></i>Passport
                                                    No.
                                                    *</label>
                                                <input type="text" class="form-control" placeholder="" name="passport_no"
                                                    aria-label="Facebook" value="{{$personal_information->passport_no}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="address"
                                                    aria-label="Twitter" value="{{$personal_information->address}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="nationality"
                                                    aria-label="Linkedin" value="{{$personal_information->nationality}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="religion"
                                                    aria-label="Instragram" value="{{$personal_information->religion}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                    ...
                                                    Status
                                                    *</label>
                                                <input type="text" class="form-control" placeholder="" name="marital_status"
                                                    aria-label="Dribble" value="{{$personal_information->marital_status}}">
                                            </div>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                    ...
                                                    *</label>
                                                <input type="text" class="form-control" placeholder=""
                                                    aria-label="Twitter" value="{{$emergency_contact->relationship}}">
                                            </div>
                                            <!-- Linkedin -->
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                    ...
                                                    *</label>
                                                <input type="text" class="form-control" placeholder=""
                                                    aria-label="Linkedin" value="{{$emergency_contact->mobile_number_primary}}">
                                            </div>
                                            <!-- Instragram -->
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                    ...
                                                    *</label>
                                                <input type="text" class="form-control" placeholder=""
                                                    aria-label="Instragram" value="{{$emergency_contact->mobile_number_secondary}}">
                                            </div>
                                            <!-- Dribble -->
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                    ...
                                                    *</label>
                                                <input type="text" class="form-control" placeholder=""
                                                    aria-label="Dribble" value="{{$emergency_contact->address_primary}}">
                                            </div>
                                            <!-- Pinterest -->
                                            <div class="col-md-6">
                                                <label class="form-label"><i
                                                    ...
                                                    *</label>
                                                <input type="text" class="form-control" placeholder=""
                                                    aria-label="Pinterest" value="{{$emergency_contact->address_secondary}}">
                                            </div>
                                        </div> <!-- Row END -->
                                    </div>
                                </div>
