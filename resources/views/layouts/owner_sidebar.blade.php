...
<html lang="en">
    ...
    <body>
        ...
        <aside>
                <nav>
                    <ul>
                        <li><a href="/Home" class="nav-item nav-link"><i class="fas fa-house"><span class="text">Home</span></a></i>
                        ...
                        <li><a href="/Full-Report" class="nav-item nav-link"><i class="fas fa-chart-pie"><span class="text">Full Report</span></a></i>
